...
public struct VehicleAppendRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(zipcode: String? = nil, city: String? = nil, address1: String, address2: String? = nil, lastName: String, state: String? = nil, firstName: String) {
