...
from Stakkd import rest
from Stakkd.configuration import Configuration
from Stakkd.exceptions import ApiTypeError, ApiValueError, ApiException
from Stakkd.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AppendApi()
        api_instance.append_demographics_post  # this is an instance of the class Endpoint
        api_instance.append_demographics_post()  # this invokes api_instance.append_demographics_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.append_demographics_post.callable or self.callable in this class
