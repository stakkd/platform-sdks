  ...
  class IpLookupResponseAddress
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::IpLookupResponseAddress` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::IpLookupResponseAddress`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'post_direction')
        self.post_direction = attributes[:'post_direction']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          city == o.city &&
          post_direction == o.post_direction &&
    ...
    def hash
      [zipcode, unit_number, city, post_direction, street_number, pre_direction, street_type, state, unit_type, street_name].hash
    end
