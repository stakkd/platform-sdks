...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StakkdApi.MobileAppendRequest();
  });
  ...
  describe('MobileAppendRequest', function() {
    it('should create an instance of MobileAppendRequest', function() {
      // uncomment below and update the code to test MobileAppendRequest
      //var instance = new StakkdApi.MobileAppendRequest();
      //expect(instance).to.be.a(StakkdApi.MobileAppendRequest);
    });
