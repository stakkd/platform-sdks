...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StakkdApi.LookupResponseAddress();
  });
  ...
  describe('LookupResponseAddress', function() {
    it('should create an instance of LookupResponseAddress', function() {
      // uncomment below and update the code to test LookupResponseAddress
      //var instance = new StakkdApi.LookupResponseAddress();
      //expect(instance).to.be.a(StakkdApi.LookupResponseAddress);
    });
