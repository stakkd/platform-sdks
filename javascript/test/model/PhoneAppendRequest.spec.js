...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StakkdApi.PhoneAppendRequest();
  });
  ...
  describe('PhoneAppendRequest', function() {
    it('should create an instance of PhoneAppendRequest', function() {
      // uncomment below and update the code to test PhoneAppendRequest
      //var instance = new StakkdApi.PhoneAppendRequest();
      //expect(instance).to.be.a(StakkdApi.PhoneAppendRequest);
    });
