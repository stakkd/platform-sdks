...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StakkdApi.PhoneVerifyRequest();
  });
  ...
  describe('PhoneVerifyRequest', function() {
    it('should create an instance of PhoneVerifyRequest', function() {
      // uncomment below and update the code to test PhoneVerifyRequest
      //var instance = new StakkdApi.PhoneVerifyRequest();
      //expect(instance).to.be.a(StakkdApi.PhoneVerifyRequest);
    });
