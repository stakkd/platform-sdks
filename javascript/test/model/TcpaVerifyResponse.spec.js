...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StakkdApi.TcpaVerifyResponse();
  });
  ...
  describe('TcpaVerifyResponse', function() {
    it('should create an instance of TcpaVerifyResponse', function() {
      // uncomment below and update the code to test TcpaVerifyResponse
      //var instance = new StakkdApi.TcpaVerifyResponse();
      //expect(instance).to.be.a(StakkdApi.TcpaVerifyResponse);
    });
