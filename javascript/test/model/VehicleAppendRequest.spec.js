...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StakkdApi.VehicleAppendRequest();
  });
  ...
  describe('VehicleAppendRequest', function() {
    it('should create an instance of VehicleAppendRequest', function() {
      // uncomment below and update the code to test VehicleAppendRequest
      //var instance = new StakkdApi.VehicleAppendRequest();
      //expect(instance).to.be.a(StakkdApi.VehicleAppendRequest);
    });
