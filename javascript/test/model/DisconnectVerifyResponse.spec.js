...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StakkdApi.DisconnectVerifyResponse();
  });
  ...
  describe('DisconnectVerifyResponse', function() {
    it('should create an instance of DisconnectVerifyResponse', function() {
      // uncomment below and update the code to test DisconnectVerifyResponse
      //var instance = new StakkdApi.DisconnectVerifyResponse();
      //expect(instance).to.be.a(StakkdApi.DisconnectVerifyResponse);
    });
