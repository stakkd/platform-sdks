...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StakkdApi.SkipTracingLookupResponse();
  });
  ...
  describe('SkipTracingLookupResponse', function() {
    it('should create an instance of SkipTracingLookupResponse', function() {
      // uncomment below and update the code to test SkipTracingLookupResponse
      //var instance = new StakkdApi.SkipTracingLookupResponse();
      //expect(instance).to.be.a(StakkdApi.SkipTracingLookupResponse);
    });
