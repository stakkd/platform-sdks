...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StakkdApi.TcpaVerifyRequest();
  });
  ...
  describe('TcpaVerifyRequest', function() {
    it('should create an instance of TcpaVerifyRequest', function() {
      // uncomment below and update the code to test TcpaVerifyRequest
      //var instance = new StakkdApi.TcpaVerifyRequest();
      //expect(instance).to.be.a(StakkdApi.TcpaVerifyRequest);
    });
