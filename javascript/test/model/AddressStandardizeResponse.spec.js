...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StakkdApi.AddressStandardizeResponse();
  });
  ...
  describe('AddressStandardizeResponse', function() {
    it('should create an instance of AddressStandardizeResponse', function() {
      // uncomment below and update the code to test AddressStandardizeResponse
      //var instance = new StakkdApi.AddressStandardizeResponse();
      //expect(instance).to.be.a(StakkdApi.AddressStandardizeResponse);
    });
