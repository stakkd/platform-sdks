...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StakkdApi.IpLookupResponseAddress();
  });
  ...
  describe('IpLookupResponseAddress', function() {
    it('should create an instance of IpLookupResponseAddress', function() {
      // uncomment below and update the code to test IpLookupResponseAddress
      //var instance = new StakkdApi.IpLookupResponseAddress();
      //expect(instance).to.be.a(StakkdApi.IpLookupResponseAddress);
    });
