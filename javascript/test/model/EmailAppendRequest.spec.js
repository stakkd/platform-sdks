...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StakkdApi.EmailAppendRequest();
  });
  ...
  describe('EmailAppendRequest', function() {
    it('should create an instance of EmailAppendRequest', function() {
      // uncomment below and update the code to test EmailAppendRequest
      //var instance = new StakkdApi.EmailAppendRequest();
      //expect(instance).to.be.a(StakkdApi.EmailAppendRequest);
    });
