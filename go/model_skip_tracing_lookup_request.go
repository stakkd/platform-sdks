...
// SkipTracingLookupRequest struct for SkipTracingLookupRequest
type SkipTracingLookupRequest struct {
...
func (o SkipTracingLookupRequest) MarshalJSON() ([]byte, error) {
...
type NullableSkipTracingLookupRequest struct {
	value *SkipTracingLookupRequest
	isSet bool
}

func (v NullableSkipTracingLookupRequest) Get() *SkipTracingLookupRequest {
	return v.value
}

func (v *NullableSkipTracingLookupRequest) Set(val *SkipTracingLookupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSkipTracingLookupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSkipTracingLookupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSkipTracingLookupRequest(val *SkipTracingLookupRequest) *NullableSkipTracingLookupRequest {
	return &NullableSkipTracingLookupRequest{value: val, isSet: true}
}

func (v NullableSkipTracingLookupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSkipTracingLookupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
