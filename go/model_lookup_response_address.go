...
// LookupResponseAddress struct for LookupResponseAddress
type LookupResponseAddress struct {
...
func (o *LookupResponseAddress) SetZipcode(v string) {
	o.Zipcode = &v
}
...
func (o LookupResponseAddress) MarshalJSON() ([]byte, error) {
...
type NullableLookupResponseAddress struct {
	value *LookupResponseAddress
	isSet bool
}

func (v NullableLookupResponseAddress) Get() *LookupResponseAddress {
	return v.value
}

func (v *NullableLookupResponseAddress) Set(val *LookupResponseAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableLookupResponseAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableLookupResponseAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLookupResponseAddress(val *LookupResponseAddress) *NullableLookupResponseAddress {
	return &NullableLookupResponseAddress{value: val, isSet: true}
}

func (v NullableLookupResponseAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLookupResponseAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
