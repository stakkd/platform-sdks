...
// EmailAppendRequest struct for EmailAppendRequest
type EmailAppendRequest struct {
...
func (o EmailAppendRequest) MarshalJSON() ([]byte, error) {
...
type NullableEmailAppendRequest struct {
	value *EmailAppendRequest
	isSet bool
}

func (v NullableEmailAppendRequest) Get() *EmailAppendRequest {
	return v.value
}

func (v *NullableEmailAppendRequest) Set(val *EmailAppendRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailAppendRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEmailAppendRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmailAppendRequest(val *EmailAppendRequest) *NullableEmailAppendRequest {
	return &NullableEmailAppendRequest{value: val, isSet: true}
}

func (v NullableEmailAppendRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmailAppendRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
