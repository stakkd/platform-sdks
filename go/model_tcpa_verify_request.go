...
// TcpaVerifyRequest struct for TcpaVerifyRequest
type TcpaVerifyRequest struct {
...
func (o TcpaVerifyRequest) MarshalJSON() ([]byte, error) {
...
type NullableTcpaVerifyRequest struct {
	value *TcpaVerifyRequest
	isSet bool
}

func (v NullableTcpaVerifyRequest) Get() *TcpaVerifyRequest {
	return v.value
}

func (v *NullableTcpaVerifyRequest) Set(val *TcpaVerifyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableTcpaVerifyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableTcpaVerifyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTcpaVerifyRequest(val *TcpaVerifyRequest) *NullableTcpaVerifyRequest {
	return &NullableTcpaVerifyRequest{value: val, isSet: true}
}

func (v NullableTcpaVerifyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTcpaVerifyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
