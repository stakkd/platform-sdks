...
// PhoneAppendResponse struct for PhoneAppendResponse
type PhoneAppendResponse struct {
...
func (o PhoneAppendResponse) MarshalJSON() ([]byte, error) {
...
type NullablePhoneAppendResponse struct {
	value *PhoneAppendResponse
	isSet bool
}

func (v NullablePhoneAppendResponse) Get() *PhoneAppendResponse {
	return v.value
}

func (v *NullablePhoneAppendResponse) Set(val *PhoneAppendResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePhoneAppendResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePhoneAppendResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhoneAppendResponse(val *PhoneAppendResponse) *NullablePhoneAppendResponse {
	return &NullablePhoneAppendResponse{value: val, isSet: true}
}

func (v NullablePhoneAppendResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhoneAppendResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
