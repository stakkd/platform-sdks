...
namespace Stakkd.Stakkd.model
{
    ...
    /// TcpaVerifyRequest
    /// </summary>
    [DataContract(Name = "tcpaVerifyRequest")]
    public partial class TcpaVerifyRequest : IEquatable<TcpaVerifyRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TcpaVerifyRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TcpaVerifyRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TcpaVerifyRequest" /> class.
        /// </summary>
        ...
        public TcpaVerifyRequest(string zipcode = default(string), string phone = default(string), string city = default(string), string address1 = default(string), string address2 = default(string), string lastName = default(string), string state = default(string), string firstName = default(string))
        {
            // to ensure "phone" is required (not null)
            if (phone == null) {
                throw new ArgumentNullException("phone is a required property for TcpaVerifyRequest and cannot be null");
            }
            this.Phone = phone;
            // to ensure "address1" is required (not null)
            if (address1 == null) {
                throw new ArgumentNullException("address1 is a required property for TcpaVerifyRequest and cannot be null");
            }
            this.Address1 = address1;
            // to ensure "lastName" is required (not null)
            if (lastName == null) {
                throw new ArgumentNullException("lastName is a required property for TcpaVerifyRequest and cannot be null");
            }
            this.LastName = lastName;
            // to ensure "firstName" is required (not null)
            if (firstName == null) {
                throw new ArgumentNullException("firstName is a required property for TcpaVerifyRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TcpaVerifyRequest {\n");
        ...
        {
            return this.Equals(input as TcpaVerifyRequest);
        }

        /// <summary>
        /// Returns true if TcpaVerifyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TcpaVerifyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TcpaVerifyRequest input)
        {
            if (input == null)
            {
                return false;
