...
namespace Stakkd.Stakkd.model
{
    ...
    /// </summary>
    [DataContract(Name = "skipTracingLookupRequest")]
    public partial class SkipTracingLookupRequest : IEquatable<SkipTracingLookupRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SkipTracingLookupRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SkipTracingLookupRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SkipTracingLookupRequest" /> class.
        /// </summary>
        ...
        public SkipTracingLookupRequest(string zipcode = default(string), string city = default(string), string address1 = default(string), string lastName = default(string), string state = default(string), string firstName = default(string))
        {
            // to ensure "address1" is required (not null)
            if (address1 == null) {
                throw new ArgumentNullException("address1 is a required property for SkipTracingLookupRequest and cannot be null");
            }
            this.Address1 = address1;
            // to ensure "lastName" is required (not null)
            if (lastName == null) {
                throw new ArgumentNullException("lastName is a required property for SkipTracingLookupRequest and cannot be null");
            }
            this.LastName = lastName;
            // to ensure "firstName" is required (not null)
            if (firstName == null) {
                throw new ArgumentNullException("firstName is a required property for SkipTracingLookupRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as SkipTracingLookupRequest);
        }

        /// <summary>
        /// Returns true if SkipTracingLookupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SkipTracingLookupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SkipTracingLookupRequest input)
        {
            if (input == null)
            {
                return false;
