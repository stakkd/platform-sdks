...
namespace Stakkd.Stakkd.model
{
    ...
    /// PhoneAppendRequest
    /// </summary>
    [DataContract(Name = "phoneAppendRequest")]
    public partial class PhoneAppendRequest : IEquatable<PhoneAppendRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneAppendRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PhoneAppendRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneAppendRequest" /> class.
        /// </summary>
        ...
        public PhoneAppendRequest(string zipcode = default(string), string city = default(string), string phone = default(string), string address1 = default(string), string address2 = default(string), string lastName = default(string), string state = default(string), string firstName = default(string))
        {
            // to ensure "address1" is required (not null)
            if (address1 == null) {
                throw new ArgumentNullException("address1 is a required property for PhoneAppendRequest and cannot be null");
            }
            this.Address1 = address1;
            // to ensure "lastName" is required (not null)
            if (lastName == null) {
                throw new ArgumentNullException("lastName is a required property for PhoneAppendRequest and cannot be null");
            }
            this.LastName = lastName;
            // to ensure "firstName" is required (not null)
            if (firstName == null) {
                throw new ArgumentNullException("firstName is a required property for PhoneAppendRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PhoneAppendRequest {\n");
        ...
        {
            return this.Equals(input as PhoneAppendRequest);
        }

        /// <summary>
        /// Returns true if PhoneAppendRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PhoneAppendRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhoneAppendRequest input)
        {
            if (input == null)
            {
                return false;
