...
namespace Stakkd.Stakkd.model
{
    ...
    /// </summary>
    [DataContract(Name = "ipLookupResponse_address")]
    public partial class IpLookupResponseAddress : IEquatable<IpLookupResponseAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IpLookupResponseAddress" /> class.
        /// </summary>
        ...
        public IpLookupResponseAddress(string zipcode = default(string), string unitNumber = default(string), string city = default(string), string postDirection = default(string), string streetNumber = default(string), string preDirection = default(string), string streetType = default(string), string state = default(string), string unitType = default(string), string streetName = default(string))
        {
        ...
        {
            return this.Equals(input as IpLookupResponseAddress);
        }

        /// <summary>
        /// Returns true if IpLookupResponseAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of IpLookupResponseAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IpLookupResponseAddress input)
        {
            if (input == null)
            {
                return false;
