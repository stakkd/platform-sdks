...
namespace Stakkd.Stakkd.model
{
    ...
    /// PhoneVerifyRequest
    /// </summary>
    [DataContract(Name = "phoneVerifyRequest")]
    public partial class PhoneVerifyRequest : IEquatable<PhoneVerifyRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneVerifyRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PhoneVerifyRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneVerifyRequest" /> class.
        /// </summary>
        ...
        public PhoneVerifyRequest(string zipcode = default(string), string city = default(string), string phone = default(string), string address1 = default(string), string address2 = default(string), string lastName = default(string), string state = default(string), string firstName = default(string))
        {
            // to ensure "phone" is required (not null)
            if (phone == null) {
                throw new ArgumentNullException("phone is a required property for PhoneVerifyRequest and cannot be null");
            }
            this.Phone = phone;
            // to ensure "address1" is required (not null)
            if (address1 == null) {
                throw new ArgumentNullException("address1 is a required property for PhoneVerifyRequest and cannot be null");
            }
            this.Address1 = address1;
            // to ensure "lastName" is required (not null)
            if (lastName == null) {
                throw new ArgumentNullException("lastName is a required property for PhoneVerifyRequest and cannot be null");
            }
            this.LastName = lastName;
            // to ensure "firstName" is required (not null)
            if (firstName == null) {
                throw new ArgumentNullException("firstName is a required property for PhoneVerifyRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PhoneVerifyRequest {\n");
        ...
        {
            return this.Equals(input as PhoneVerifyRequest);
        }

        /// <summary>
        /// Returns true if PhoneVerifyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PhoneVerifyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhoneVerifyRequest input)
        {
            if (input == null)
            {
                return false;
