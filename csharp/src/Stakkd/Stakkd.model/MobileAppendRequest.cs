...
namespace Stakkd.Stakkd.model
{
    ...
    /// MobileAppendRequest
    /// </summary>
    [DataContract(Name = "mobileAppendRequest")]
    public partial class MobileAppendRequest : IEquatable<MobileAppendRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MobileAppendRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MobileAppendRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MobileAppendRequest" /> class.
        /// </summary>
        ...
        /// <param name="phone">The phone to use in the request..</param>
        ...
        public MobileAppendRequest(string zipcode = default(string), string city = default(string), string phone = default(string), string address1 = default(string), string address2 = default(string), string lastName = default(string), string state = default(string), string firstName = default(string))
        {
            // to ensure "address1" is required (not null)
            if (address1 == null) {
                throw new ArgumentNullException("address1 is a required property for MobileAppendRequest and cannot be null");
            }
            this.Address1 = address1;
            // to ensure "lastName" is required (not null)
            if (lastName == null) {
                throw new ArgumentNullException("lastName is a required property for MobileAppendRequest and cannot be null");
            }
            this.LastName = lastName;
            // to ensure "firstName" is required (not null)
            if (firstName == null) {
                throw new ArgumentNullException("firstName is a required property for MobileAppendRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MobileAppendRequest {\n");
        ...
        {
            return this.Equals(input as MobileAppendRequest);
        }

        /// <summary>
        /// Returns true if MobileAppendRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MobileAppendRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MobileAppendRequest input)
        {
            if (input == null)
            {
                return false;
