...
namespace Stakkd.Stakkd.model
{
    ...
    /// EmailAppendRequest
    /// </summary>
    [DataContract(Name = "emailAppendRequest")]
    public partial class EmailAppendRequest : IEquatable<EmailAppendRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailAppendRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailAppendRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailAppendRequest" /> class.
        /// </summary>
        ...
        public EmailAppendRequest(string zipcode = default(string), string city = default(string), string address1 = default(string), string address2 = default(string), string lastName = default(string), string state = default(string), string firstName = default(string))
        {
            // to ensure "address1" is required (not null)
            if (address1 == null) {
                throw new ArgumentNullException("address1 is a required property for EmailAppendRequest and cannot be null");
            }
            this.Address1 = address1;
            // to ensure "lastName" is required (not null)
            if (lastName == null) {
                throw new ArgumentNullException("lastName is a required property for EmailAppendRequest and cannot be null");
            }
            this.LastName = lastName;
            // to ensure "firstName" is required (not null)
            if (firstName == null) {
                throw new ArgumentNullException("firstName is a required property for EmailAppendRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailAppendRequest {\n");
        ...
        {
            return this.Equals(input as EmailAppendRequest);
        }

        /// <summary>
        /// Returns true if EmailAppendRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailAppendRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailAppendRequest input)
        {
            if (input == null)
            {
                return false;
