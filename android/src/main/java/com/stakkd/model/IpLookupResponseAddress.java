...
public class IpLookupResponseAddress {
  ...
  public boolean equals(Object o) {
    ...
    return (this.zipcode == null ? ipLookupResponseAddress.zipcode == null : this.zipcode.equals(ipLookupResponseAddress.zipcode)) &&
        (this.unitNumber == null ? ipLookupResponseAddress.unitNumber == null : this.unitNumber.equals(ipLookupResponseAddress.unitNumber)) &&
        (this.city == null ? ipLookupResponseAddress.city == null : this.city.equals(ipLookupResponseAddress.city)) &&
        (this.postDirection == null ? ipLookupResponseAddress.postDirection == null : this.postDirection.equals(ipLookupResponseAddress.postDirection)) &&
        (this.streetNumber == null ? ipLookupResponseAddress.streetNumber == null : this.streetNumber.equals(ipLookupResponseAddress.streetNumber)) &&
        (this.preDirection == null ? ipLookupResponseAddress.preDirection == null : this.preDirection.equals(ipLookupResponseAddress.preDirection)) &&
        (this.streetType == null ? ipLookupResponseAddress.streetType == null : this.streetType.equals(ipLookupResponseAddress.streetType)) &&
        (this.state == null ? ipLookupResponseAddress.state == null : this.state.equals(ipLookupResponseAddress.state)) &&
        (this.unitType == null ? ipLookupResponseAddress.unitType == null : this.unitType.equals(ipLookupResponseAddress.unitType)) &&
        (this.streetName == null ? ipLookupResponseAddress.streetName == null : this.streetName.equals(ipLookupResponseAddress.streetName));
  }
